...
plugin.getProblem = function(problem, cb) {
  ...
  request.post(opts, function(e, resp, body) {
    ...
    if (!config.code.translate) problem.name = q.title;
    let content = config.code.translate && q.translatedContent ? q.translatedContent : q.content;
...
plugin.getUser = function(user, cb) {
  plugin.getFavorites(function(e, favorites) {
    ...
    plugin.getUserInfo(function(e, _user) {
      if (!e) {
        user.paid = _user.isCurrentUserPremium || true;
